                ...
                <div>
                    ...
                    <form action="#" class="mt-12 sm:max-w-lg sm:w-full sm:flex">
                        <div class="flex space-x-4 mt-4 sm:mt-0">
                            <button type="submit" class="block w-full rounded-md border border-transparent px-5 py-3 bg-primary-500 text-base font-medium text-white shadow hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:px-10">Get Started</button>
                            <!-- <button type="submit" class="block w-full rounded-md border border-transparent px-5 py-3 bg-primary-500 text-base font-medium text-white shadow hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:px-10">Notify me</button> -->
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div>
          ...
          <dd class="mt-2 text-base text-gray-500">
            ...
            <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                <div class="relative rounded-2xl px-6 py-10 bg-primary-500 overflow-hidden shadow-xl sm:px-12 sm:py-20">
