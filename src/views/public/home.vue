    ...
    <div>
        <div class="relative bg-white ">
            <div class="max-w-7xl mx-auto flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
                <div>
                    <a href="#" class="flex">
                        <span class="sr-only">Watchtower</span>
        ...
        <main>
            <!-- Hero section -->
            <div class="pt-8 overflow-hidden lg:relative lg:py-48">
            <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
                <div>
                    <div class="sm:max-w-xl">
                    <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
                        Ticket management for growing businesses
                    </h1>
                    <p class="mt-6 text-xl text-gray-500">
                        Premium omni-channel ticketing system to reach your customers effectively.
                    </p>
                    </div>
                    <form action="#" class="mt-12 sm:max-w-lg sm:w-full sm:flex">
                        <div class="flex space-x-4 mt-4 sm:mt-0">
                            <button type="submit" class="block w-full rounded-md border border-transparent px-5 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-base font-medium text-white shadow hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:px-10">Get Started</button>
                            <!-- <button type="submit" class="block w-full rounded-md border border-transparent px-5 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-base font-medium text-white shadow hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:px-10">Notify me</button> -->
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
                ...
                <div class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
                    <img class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="/images/showcase.png" alt="">
                </div>
                </div>
            </div>
            </div>
  ...
  <div class="relative max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
      ...
      <dl class="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
        <div>
          <dt>
            <div class="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-r from-primary-500 to-primary-600 text-white">
          ...
          <dd class="mt-2 text-base text-gray-500">
            ...
            <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
                ...
                <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-primary-500 to-primary-600" style="mix-blend-mode: multiply;"></div>
                    ...
                    <div class="relative px-8">
                        ...
                        <div class="relative text-lg font-medium text-white md:flex-grow">
                            <svg class="absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-primary-400" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
            ...
            <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                <div class="relative rounded-2xl px-6 py-10 bg-gradient-to-r from-primary-500 to-primary-600 overflow-hidden shadow-xl sm:px-12 sm:py-20">
                <div aria-hidden="true" class="absolute inset-0 -mt-72 sm:-mt-32 md:mt-0">
                    <svg class="absolute inset-0 h-full w-full" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1463 360">
                    <path class="text-primary-400 text-opacity-40" fill="currentColor" d="M-82.673 72l1761.849 472.086-134.327 501.315-1761.85-472.086z" />
                ...
                <div class="relative">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <input id="cta_email" type="email" class="block w-full border border-transparent rounded-md px-5 py-3 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-500" placeholder="Enter your email">
                    </div>
                    <div class="mt-4 sm:mt-0 sm:ml-3">
                        <button type="submit" class="block w-full rounded-md border border-transparent px-5 py-3 bg-gray-900 text-base font-medium text-white shadow hover:bg-black focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-500 sm:px-10">Notify me</button>
                    </div>
                    </form>
                </div>
                </div>
    ...
    <div class="relative">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
          <div class="flex-1 bg-gray-50 px-6 py-8 lg:p-12">
            ...
            <div class="mt-8">
              <div class="flex items-center">
                <h4 class="flex-shrink-0 pr-4 bg-white text-sm tracking-wider font-semibold uppercase text-primary-600">
                  What's included
                </h4>
          ...
          <div class="py-8 px-6 text-center bg-gradient-to-r from-primary-500 to-primary-600 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
            <p class="relative grid grid-cols-1 px-16">
                <span class="flex flex-col text-center">
                    <span class="text-5xl font-extrabold text-white tracking-tight">$7.00</span>
                    <span class="mt-2 text-base font-medium text-primary-200 uppercase">Per User</span>
  ...
  <div class="pt-12 sm:pt-16 lg:pt-24">
    <div class="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto space-y-2 lg:max-w-none">
        <h2 class="text-lg leading-6 font-semibold text-gray-800 uppercase tracking-wider">
          Pricing
        </h2>
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="space-y-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
          <div class="flex flex-col rounded-lg shadow-lg">
            <div class="px-6 py-8 bg-white rounded-lg border sm:p-10 sm:pb-6">
              <div>
